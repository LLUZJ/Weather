...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(0, 0, 800, 459));
...
"padding: 1px 5px"));
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/res/search(1).png"), QSize(), QIcon::Normal, QIcon::Off);
...
"padding:8px;"));
        ...
        lblHighCurve->setEnabled(true);
        lblHighCurve->setMinimumSize(QSize(0, 71));
